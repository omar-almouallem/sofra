...
export const basicSignupValidationSchema = yup.object({
  ...
  password: yup
    ...
    first_name :yup.string().max(10, ERROR_MESSAGES.PASSWORD_TOO_LONG)
    .min(2, ERROR_MESSAGES.PASSWORD_TOO_SHORT),
    last_name :yup.string().max(10, ERROR_MESSAGES.PASSWORD_TOO_LONG)
    .min(2, ERROR_MESSAGES.PASSWORD_TOO_SHORT),
